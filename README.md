...
This repository was generated by **Lee Wilson** as part of a Data Wrangling and Versioning workshop, which took place at the [Canadian Data Curation Forum](https://data-curation.github.io/).
...
Access the original at [https://ndownloader.figshare.com/files/11502815](https://ndownloader.figshare.com/files/11502815)

-------------------
# GENERAL INFORMATION

Title of Dataset: Studying African Farmer-Led Irrigation (SAFI) Analysis

Author Information (Name, Institution, Address, Email)

	Principal Investigator: Lee Wilson
	Associate or Co-investigator: Jay Brodeur
	Alternate Contact(s):

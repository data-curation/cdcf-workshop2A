...
This repository was generated by Patrick LeClair as part of a Data Wrangling and Versioning workshop, which took place at the [Canadian Data Curation Forum](https://data-curation.github.io/).

-------------------
# GENERAL INFORMATION

Title of Dataset: A changed version that I made for this workshop

Author Information (Name, Institution, Address, Email)

	Principal Investigator: Patrick LeClair
	Associate or Co-investigator: 
	Alternate Contact(s):

Date of data collection (single date, range, approximate date): 20191016

Geographic location of data collection: Hamilton, Ontario 
